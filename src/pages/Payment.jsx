...
const Payment = ({ eventName }) => {
  ...
  return (
    <section className=" dashboard-bg pb-10  xl:h-[180vh] ">
      ...
      <div
        id="options"
        className="mx-2  gap-y-4  xl:flex-row sm:items-start  flex-col-reverse flex justify-center gap-x-10 "
      >
        <form className=" flex flex-col  lg:pt-10">
        ...
        <div className=" flex pt-24 lg:pt-10 flex-col max-w-[700px]  ">
          <motion.div
            initial={{
              background: 'linear-gradient(280deg, #0a0a0a 0%, #171717 40%)',
            }}
